...
include ("../controlador/tatuadoresControlador.php");
include("editarSesionEmpleado.php");
?>
...
$c = new conexion();
$cone =$c -> conectando();
$sql = "select max(idEmpleado) from empleado";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                    ...
                    <input type="text"  value="<?php echo $obj->idEmpleado ?>"readonly name="idEmpleado" class="form-control" id="exampleInputText2" disabled>
                  </div>
                  <div class="mb-3">
                  <label for="exampleInputText1" class="form-label">Nombre</label>
                  <input type="text" name="nombreEmpleado" class="form-control" id="exampleInputText1">
                </div>
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Ingrese su correo</label>
                  <input type="email" name="correoEmpleado" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Contraseña</label>
                    <input type="password" name="contrasenaEmpleado" class="form-control" id="exampleInputPassword1">
                  </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Telefono</label>
                  <input type="number" name="telefonoEmpleado" class="form-control" id="exampleInputTelfono1">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Cargo</label>
                  <input type="number" name="idCargo" class="form-control" id="exampleInputPassword1">
                </div>
...
<div class="container bg-light p-3 my-5 rounded">
      ...
      <form class="d-flex"  method="post">
        ...
        <input class="form-control me-2" type="search" name ="idEmpleado" id="idEmpleado" placeholder="Ingresa el codigo del empleado" aria-label="Search">
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <input type="hidden"  name="idEmpleado" value="<?php echo $res[0]; ?>">
...
<script>
  $(document).ready(function(){
    $('.editarM').on('click', function(){
        ...
        $('#nombreEmpleado').val(data[1]);
        $('#correoEmpleado').val(data[2]);
        $('#conrasenaEmpleado').val(data[3]);
        $('#telefonoEmpleado').val(data[4]);
        $('#idCargo').val(data[5]);
    });
});
</script>
